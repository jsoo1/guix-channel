    ...
    (package
     ...
     (source
      (origin
       ...
       (sha256 (base32 "1jn5z2ylccjkp9i12n5x53x2zzhhsgmgs6xxi7aja6qimfw90h1n"))))
     (build-system gnu-build-system)
     (home-page "https://github.com/saitoha/libsixel")
     (synopsis "A SIXEL encoder/decoder implementation derived from kmiya's sixel (https://github.com/saitoha/sixel).")
     (description

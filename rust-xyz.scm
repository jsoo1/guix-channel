...
(define-public rust-rustc-serialize
  (package
    ...
    (description
     "Generic serialization/deserialization support corresponding to
the `derive(RustcEncodable, RustcDecodable)` mode in the compiler.
Also includes support for hex, base64, and json encoding and
decoding.")
    (license #f)))
  ...
  (package
    ...
    (source
      (origin
        ...
        (file-name (string-append (package-name rust-log) "-" version ".tar.gz"))
        (sha256
         (base32
...
(define-public rust-objc
  (package
    ...
    (arguments
     `(#:cargo-inputs
       (("rust-malloc-buf" ,rust-malloc-buf)
...
(define rust-andrew
  (package
    ...
    (arguments
     `(#:cargo-inputs
       (("rust-bitflags" ,rust-bitflags)
        ("rust-line-drawing" ,rust-line-drawing)

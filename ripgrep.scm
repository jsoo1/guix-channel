...
(define rust-unicode-segmentation
  (package
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1cqxka1fpa3sldhd1zg6lv2bxcvcq18m1zh2sknbzcs1x2n607h5"))))
    (build-system cargo-build-system)
    (arguments
     `(#:cargo-inputs
       (("rust-bitflags" ,rust-bitflags)
...
(define rust-rustc-std-workspace-core
  (package
...
(define rust-winapi-i686-pc-windows-gnu
  (package
...
(define rust-winapi-x86-64-pc-windows-gnu
  (package
...
(define rust-hyphenation-commons
  (package
...
(define rust-unicode-normalization
  (package
...
(define rust-signal-hook-registry
  (package
...
(define rust-encoding-index-japanese
  (package
...
(define rust-encoding-index-korean
  (package
...
(define rust-encoding-index-simpchinese
  (package
...
(define rust-encoding-index-singlebyte
  (package
...
(define rust-encoding-index-tradchinese
  (package
...
(define rust-fuchsia-zircon-sys
  (package
...
(define rust-futures-channel-preview
  (package
...
(define rust-futures-executor-preview
  (package
...
(define rust-futures-util-preview
  (package
...
(define rust-stdweb-internal-macros
  (package
...
(define rust-stdweb-internal-runtime
  (package
...
(define rust-stdweb-internal-test-macro
  (package
...
(define rust-tokio-current-thread
  (package
...
(define rust-console-error-panic-hook
  (package
...
(define rust-wasm-bindgen-futures
  (package
...
(define rust-encoding-index-tests
  (package
...
(define rust-futures-core-preview
  (package
...
(define rust-futures-io-preview
  (package
...
(define rust-futures-select-macro-preview
  (package
...
(define rust-futures-sink-preview
  (package
...
(define rust-new-debug-unreachable
  (package
...
(define rust-synstructure-test-traits
  (package
...
(define rust-stable-deref-trait
  (package
...
(define rust-peeking-take-while
  (package
...
(define rust-wasm-bindgen-macro
  (package
...
(define rust-wasm-bindgen-macro-support
  (package
...
(define rust-wasm-bindgen-backend
  (package
...
(define rust-foreign-types-macros
  (package
...
(define rust-foreign-types-shared
  (package
